...
export const Projects: React.FC = () => {
  ...
  const suggestions = {
    ...
    'By Skill': [
      {
        title: 'High-Throughput JWT Auth Service',
        desc: 'Microservice with refresh tokens, rate limiting, and password hashing.',
    ...
    'Hackathon': [
      {
        title: 'AI Student Study Buddy Live',
        desc: 'Real-time flashcards generator and quiz evaluator using multimodal vision.',
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold shadow-xs transition self-start sm:self-auto">

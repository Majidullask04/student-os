...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: List[str] = [
        ...
        for origin in os.getenv(
            "CORS_ORIGINS", 
            "http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000,http://localhost:3030,http://127.0.0.1:3030,http://localhost:8000,https://student-os.vercel.app,https://student-os-lime-psi.vercel.app"
        ).split(",")
        if origin.strip()
    ]
